...
loader.load('/thirdPartyCode/fonts/helvetiker_bold.typeface.json', function (font) {
...
app.vuforia.isAvailable().then(function (available) {
    ...
    app.vuforia.init({
        ...
        api.objectTracker.createDataSet("/thirdPartyCode/datasets/ArgonTutorial.xml").then(function (dataSet) {
        ...
        api.objectTracker.createDataSet("/thirdPartyCode/datasets/StonesAndChips.xml").then(function (dataSet) {
            // the data set has been succesfully downloaded
            // tell vuforia to load the dataset.  
            dataSet.load().then(function () {
                // when it is loaded, we retrieve a list of trackables defined in the
